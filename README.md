...
В этом проекте я использовал бинарную логистическую регрессию для классификации твитов на токсичные (1) и нетоксичные (0) с помощью набра данных из более 30 тысяч реальных твитов.
...
|----------------|--------------------|----------------|----------|----------------|
| 0 (Не-Токсик) | 0.98               | 0.93           | 0.96     | 5945           |
| 1 (Токсик) | 0.48               | 0.80           | 0.60     | 448            |
| **Accuracy**      |                    |                | 0.93     | 6393           |
